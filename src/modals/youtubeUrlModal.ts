...
export class YouTubeUrlModal extends Modal {
  ...
  async onOpen() {
    ...
    // Only add formats that are enabled in settings
    ...
    enabledFormats.forEach((format) => {
      ...
      // Auto-check createNewFile if PDF or SRT is selected
    ...
    // Show/hide directory and file format container based on createNewFile checkbox
